...
//go:embed migrations/001_create_records.sql
var migration001 string

// Migration is one ordered adapter-owned schema change.
...
func (store *Store) Migrations() []Migration {
	...
	return []Migration{{Version: 1, Name: "create_records", SQL: replacer.Replace(migration001)}}
}
